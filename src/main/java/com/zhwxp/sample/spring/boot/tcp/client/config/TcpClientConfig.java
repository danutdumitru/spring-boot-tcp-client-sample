...
public class TcpClientConfig implements ApplicationEventPublisherAware {
	...
	public AbstractClientConnectionFactory clientConnectionFactory() {
		...
		tcpNioClientConnectionFactory.setSerializer(new MK500SerializerDeserializer());
		tcpNioClientConnectionFactory.setDeserializer(new MK500SerializerDeserializer());
